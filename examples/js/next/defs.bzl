...
def next(
    ...
    next(
        ...
        data = [
            ...
            "//examples/js/next:node_modules/react-dom",
            "//examples/js/next:node_modules/react",
            "//examples/js/next:node_modules/typescript",
            "next.config.js",
            "package.json",
        ],
    ...
    ```
    //examples/js/next:next
    //examples/js/next:next_dev
    //examples/js/next:next_start
    ```
    ...
    ```
    bazel build //examples/js/next:next
    ```
    ...
    ```
    ibazel run //examples/js/next:next_dev
    ```
    ...
    ```
    ibazel run //examples/js/next:next_start
    ```
    ...
    ```
    bazel build //examples/js/next:next_export
    ```
